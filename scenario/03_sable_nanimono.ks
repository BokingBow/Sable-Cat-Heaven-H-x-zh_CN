...
[tb_start_text mode=3 ]
虽然平常总是看到萨布列做这种事情，但换成人类尺寸后，飞散的灰尘量非比寻常。[p][r]
...
[tb_start_text mode=3 ]
「哎呀哎呀，你是……」[p][r]
被幼崽抱住的雪奶奶，暂时停止了动作。[p][r]
「喵～」[p][r]

[_tb_end_text]

[tb_start_text mode=3 ]
幼崽将脸埋在雪奶奶的腹部，蹭来蹭去。[p][r]
「啊……它是我在神社发现的。[l][r]
因为没有家长在……我问了警察，[l][r]
但没有结果……所以就请人调查了，[l][r]
...
[tb_start_text mode=3 ]
「青花鱼！！！」[p][r]
小贾夺走雪奶奶放下的盘子，直接把盘子放在地上，把鱼肉塞进嘴里。[p][r]
