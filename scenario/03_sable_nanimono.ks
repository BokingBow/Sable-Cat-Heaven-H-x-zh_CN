[_tb_system_call storage=system/_03_sable_nanimono.ks]

[mask  time="1000"  effect="fadeIn"  color="0x000000"  ]
[stopbgm  time="1500"  fadeout="true"  ]
[tb_show_message_window  ]
[bg  time="0"  method="crossfade"  storage="BG/douroo.png"  ]
[tb_image_show  time="1"  storage="default/waku.png"  width="1280"  height="720"  name="img_4"  ]
[chara_show  name="niya"  time="o"  wait="true"  storage="chara/1/Niya_nom.png"  width="1280"  height="720"  top="0"  ]
[chara_show  name="sable"  time="0"  wait="true"  storage="chara/3/Sable_kuufuku.png"  width="1280"  height="720"  top="0"  ]
[mask_off  time="1000"  effect="fadeOut"  ]
[playbgm  volume="70"  time="1000"  loop="true"  storage="madeinsummer1.mp3"  ]
[tb_start_text mode=3 ]
「马鲛鱼！」[p][r]
「喂，为什么这家伙只会说鱼的名字呢？」[p][r]
...
[bg  time="1000"  method="crossfade"  storage="BG/bouban.png"  ]
...
[chara_mod  name="other"  time="600"  cross="true"  storage="chara/11/omawari_odo.png"  ]
[tb_start_text mode=3 ]
「哇，那是什么，耳朵长在头上的小鬼！」[p][r]
耳朵长在头上的小鬼。[l][r]
不过，是没错啦。[p][r]
「我们在神社收留了她，有人申报走失儿童吗？」[p][r]
...
[chara_move  name="sable"  anim="true"  time="300"  effect="linear"  wait="true"  left="140"  ]
[tb_start_text mode=3 ]
结果它一边威吓我，一边躲到妮娅后面。[p][r]
...
[tb_start_text mode=3 ]
虽然平常总是看到莎布蕾做这种事情，但换成人类尺寸后，飞散的灰尘量非比寻常。[p][r]
...
「这个……」[p][r]
「比目鱼！」[p][r]
从桌子底下跳出来的小鬼，这次朝着雪奶奶发动了突击。[l][r]

[_tb_end_text]

[chara_mod  name="sable"  time="600"  cross="true"  storage="chara/3/Sable_w.png"  ]
[chara_move  name="sable"  anim="true"  time="300"  effect="linear"  wait="true"  left="-100"  ]
[tb_start_text mode=3 ]
啪。[p][r]
...
[tb_start_text mode=3 ]
「哎呀哎呀，你是……」[p][r]
被小鬼抱住的雪奶奶，暂时停止了动作。[p][r]
「咪～」[p][r]

[_tb_end_text]

[tb_start_text mode=3 ]
小鬼将脸埋在雪奶奶的腹部，蹭来蹭去。[p][r]
「啊……是我在神社发现的[l][r]
好像没有家长在……问过警察了[l][r]
但没有找到……已经拜托他们帮忙调查了[l][r]
...
[tb_start_text mode=3 ]
正如被抛弃的猫再也见不到父母一样，[l][r]
这孩子，也已经没有能见的家人了吗。[l][r]
不知为何，我这么想道。[p][r]
「这孩子，好像肚子饿了呢……」[p][r]

[_tb_end_text]

[chara_mod  name="baacyan"  time="600"  cross="true"  storage="chara/5/baachan_mom.png"  ]
[tb_start_text mode=3 ]
「是吗，那得给它吃的了」[p][r]
雪奶奶这么说着。[p][r]
...
[chara_move  name="sable"  anim="true"  time="300"  effect="linear"  wait="true"  left="-20"  ]
...
[tb_start_text mode=3 ]
「青花鱼！！！」[p][r]
小鬼夺走雪奶奶放下的盘子，直接把盘子放在地上，把鱼肉塞进嘴里。[p][r]
...
[tb_start_text mode=3 ]
它在我肚子附近用脑袋咕噜咕噜地来回蹭着，似乎想找个好的角度安顿下来。[p][r]
「你……果然是莎布蕾吗……？」[p][r]
「咪～」[p][r]
然后它叫了一声，闭上眼睛睡着了。[p][r]
...
[jump  storage="04_taiiniwai.ks"  target=""  ]
